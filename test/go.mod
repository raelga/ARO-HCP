...
require (
	...
	github.com/Azure/ARO-Tools/tools/registration v0.0.0-20260709090636-c3198b56b79a // indirect
	github.com/Azure/ARO-Tools/tools/secret-sync v0.0.0-20260709090636-c3198b56b79a // indirect
